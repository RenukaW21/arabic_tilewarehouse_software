  ...
  return (
    <div>
      ...
      <DataTableShell<DamageEntry>
        ...
        isLoading={isLoading}
      />
      <CrudFormDialog open={dialogOpen} onClose={() => { setDialogOpen(false); setEditing(null); }} onSubmit={(d) => saveMutation.mutateAsync(d)} fields={fields} title={editing ? t('damageEntries.editEntry') : t('damageEntries.newEntry')} initialData={editing} loading={saveMutation.isPending} />
